...
import { FaEdit, FaSearch, FaUserCircle, FaTrash, FaPlus } from 'react-icons/fa';
    ...
    <div className={styles.container}>
      ...
      <div className={styles.toolbar}>
        <div className={styles.searchBox}>
          ...
          <input type="text" placeholder="Tìm người dùng theo tên hoặc email..." className={styles.searchInput} />
        </div>
      </div>
              ...
              <tr key={user.id}>
                ...
                <td className={styles.userCell}>
                    ...
                    <div className={styles.userInfo}>
                        <div className={styles.userName}>{user.tenDangNhap || user.hoTen || user.name || 'Chưa có tên'}</div>
                ...
                <td>
                 ...
                 <tr>
                    <td colSpan="4" style={{textAlign: 'center', padding: '20px'}}>Không tìm thấy người dùng</td>
                </tr>
            )}
          </tbody>
        </table>
