...
-- Insert NguoiDung
set dateformat ymd
INSERT INTO NguoiDung (tenDangNhap, matKhau, hoTen, email, anhDaiDien, LastLogin, Streak) VALUES
('user1', 'password123', N'Nguyễn Văn A', 'user1@email.com', 'avatar1.jpg', '2024-01-15 08:30:00', 5),
('user2', 'password456', N'Trần Thị B', 'user2@email.com', 'avatar2.jpg', '2024-01-14 10:15:00', 3),
('user3', 'password789', N'Lê Văn C', 'user3@email.com', 'avatar3.jpg', '2024-01-13 14:20:00', 7);
